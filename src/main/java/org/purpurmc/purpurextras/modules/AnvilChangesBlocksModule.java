...
/**
 * If enabled, block list will be used. Key is the block material that will be
 * converted from and value is block material that will be converted to. In
 * default config if anvil falls on a cobblestone block, that cobblestone will
 * be converted to sand.
 */

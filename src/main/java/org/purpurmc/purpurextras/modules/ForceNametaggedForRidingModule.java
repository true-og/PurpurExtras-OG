...
/**
 * If enabled, only nametagged mobs can be mounted/steered using purpur's
 * rideable option.
 */
public class ForceNametaggedForRidingModule implements PurpurExtrasModule, Listener {
    ...
    public boolean shouldEnable() {
        ...
        return PurpurExtrasOG.getPurpurConfig().getBoolean("settings.rideables.mob-needs-to-be-nametagged-to-ride",
                false);

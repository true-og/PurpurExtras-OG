...
/**
 * If enabled, players having target.bypass.<mojang_mob_name> permission won't
 * be targetted by that type of mob.
 */
public class MobNoTargetModule implements PurpurExtrasModule, Listener {
    ...
    public boolean shouldEnable() {
        ...
        return PurpurExtrasOG.getPurpurConfig().getBoolean("settings.use-notarget-permissions", false);

...
public class OpenIronDoorsWithHandModule implements PurpurExtrasModule, Listener {
    ...
    public boolean shouldEnable() {
        DefaultPermissions.registerPermission(
                openIronDoorsPermission, "Allows for opening iron doors with a hand", PermissionDefault.TRUE);
        DefaultPermissions.registerPermission(
                openIronTrapdoorsPermission, "Allows for opening iron trapdoors with a hand", PermissionDefault.TRUE);
